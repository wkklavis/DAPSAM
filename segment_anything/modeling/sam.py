...
class Sam(nn.Module):
    ...
    def __init__(
        ...
        # self.prompt_generator = PrototypePromptGenerate(image_embedding_size=self.image_encoder.img_size//self.image_encoder.patch_size)
    ...
    def forward_train(self, batched_input, multimask_output, image_size):
        ...
        low_res_masks, iou_predictions = self.mask_decoder(
            ...
            image_pe=self.prompt_encoder.get_dense_pe(),#self.prompt_generator.get_dense_pe()
            sparse_prompt_embeddings=sparse_embeddings,
            dense_prompt_embeddings=dense_embeddings,#prompt
